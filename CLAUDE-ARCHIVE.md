...
Fix history for Statalizers, split out of `CLAUDE.md` on 2026-08-19.

Entries are verbatim and in their original order. Nothing here was reworded. The
standing rules, architecture and current state stayed in `CLAUDE.md`; what moved
here is the record of how each thing came to be the way it is.

Read a section when debugging that subsystem. The history is often the whole
answer: most bugs in this project were second occurrences of a pattern already
described here.
